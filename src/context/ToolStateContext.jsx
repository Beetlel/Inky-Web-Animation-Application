...
    rectangle: { size: 2, opacity: 1, color: '#000000', fillColor: 'transparent' },
...
    lastActiveDrawingTool: 'brush',

    // Brush Tool Properties
    brushProperties: BRUSH_PRESETS.pen,
...
    recentColors: [],
    addRecentColor: () => {},
    // --- NEW: Edit Mode Tools and Properties ---
